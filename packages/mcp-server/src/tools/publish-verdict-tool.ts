 ...
 * rollup selector: provider resolves window to live QcMetricsSnapshot (finding
 * yield, false positive rate, reviewer delta, post-merge bug rate). Generator
 * writes metrics snapshot + verdict into bundle.
 *
 * Phase C bootstrap: metrics are zero-baseline (no live review telemetry wired yet).
 *
